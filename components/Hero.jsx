          ...
          <div className="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12">
            <header className="crumina-module crumina-heading heading--h2 heading--with-decoration">
              ...
              <div className="heading-text">
                Welcome to our Web 3.0 Liquidity Marketplace, a pioneering platform designed to revolutionize
                the way liquidity is managed in the decentralized finance (DeFi) ecosystem. Our marketplace
                is built on the principles of Web 3.0, offering a decentralized, trustless, and user-centric approach to
                liquidity provision.
